...
INSERT INTO "new_Turma" ("created_at", "defaultMonthlyFeeCents", "defaultPaymentMethod", "id", "name", "schedule", "status", "unitId", "updated_at") SELECT "created_at", "defaultMonthlyFeeCents", "defaultPaymentMethod", "id", "name", "schedule", "status", "unitId", "updated_at" FROM "Turma";
DROP TABLE "Turma";
